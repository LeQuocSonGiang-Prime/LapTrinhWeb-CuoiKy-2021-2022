        ...
        <div class="row">
            <div class="col l-6 m-12 c-12 confirm-content">
                ...
                <div class="confirm-content-login">
                    ...
                    <input type="text" >
                    <p>Chúng tôi sẽ gọi điện hoặc nhắn tin cho bạn để xác nhận số điện thoại. Có áp dụng phí dữ liệu và phí tin nhắn tiêu chuẩn. <a href="">Chính sách về quyền riêng tư</a></p>
