        ...
        <div class="introduce">
            <div class="grid wide">
                <div class="row">
                    ...
                    <div class="introduce-backgroud col l-3 m-6 c-12" data-aos="zoom-in-up" data-aos-duration="1000">
                        <img src="./img/introduce/lissete-laverde-7OFTxbGWqwk-unsplash.jpg" alt="" class="introduce-img">
                        <div class="intro-content">
                        ...
                        <div class="col l-3 m-6 c-12 buy-list" data-aos="zoom-in-up" data-aos-duration="1000">
                            <a class="catalog-singer-link-a" href="./detail.html">
                                ...
                                <div class="buy-info-item">
                                    ...
                                    <p class="buy-text">Bao gồm các studio và căn hộ 1 và 2 phòng ngủ có thiết kế lấy cảm hứng từ đô thị.</p>
                                </div>
                            </a>
                        </div>
                        <!-- Item 2 -->
                        ...
                        <div class="col l-3 m-6 c-12 buy-list" data-aos="zoom-in-down" data-aos-duration="1000">
                            <a class="catalog-singer-link-a" href="./detail.html">
                                ...
                                <div class="buy-info-item">
                                    ...
                                    <p class="buy-text">Hãy tận hưởng niềm vui của bạn từ một vị trí thuận lợi có thể dễ dàng tiếp cận tất cả những gì tốt nhất của khu South Beach.</p>
                                </div>
                            </a>
                        </div>
                        <!-- Item 3 -->
                        ...
                        <div class="col l-3 m-6 c-12 buy-list" data-aos="zoom-in-up" data-aos-duration="1000">
                            <a class="catalog-singer-link-a" href="./detail.html">
                                ...
                                <div class="buy-info-item">
                                    ...
                                    <p class="buy-text">Mang đến cơ hội duy nhất để sống và tận hưởng những khu dân cư yên tĩnh, vị trí thuận tiện, không gian thoáng đẹp.</p>
                                </div>
                            </a>
                        </div>
        ...
        <div class="parallax-ser">
            <div class="tool-ser">
                ...
                <div class="serBox" data-aos="zoom-out-down" data-aos-duration="1000">
                    ...
                    <div class="serContent">
                        <h2>HÀNG ĐẦU</h2>
                        <p> TẤT CẢ CÁC NGÔI NHÀ CHO THUÊ CỦA CHÚNG TÔI ĐỀU RẤT TUYỆT VỜI TRONG KHU VỰC GẦN ĐÓ, SẴN SÀNG GIÚP BẠN TÌM KIẾM NGÔI NHÀ HOÀN HẢO.</p>
                    </div>
                </div>
                <div class="serBox" data-aos="zoom-out-down" data-aos-duration="1000">
                    ...
                    <div class="serContent">
                        ...
                        <p>TẤT CẢ CÁC CƠ SỞ VẬT CHẤT ĐỀU ĐẦY ĐỦ TIỆN NGHI CHO BẠN 1 CẢM GIÁC THOẢI MÁI NHẤT.</p>
                    </div>
                </div>
