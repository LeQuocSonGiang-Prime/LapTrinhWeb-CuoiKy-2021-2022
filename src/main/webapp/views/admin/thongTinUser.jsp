...
<div id="logout-modal" class="modal">
  ...
  <div class="modal-content">
    ...
    <p style="color: #fff; font-size: 18px;">Vui lòng xác nhận để đăng xuất</p>
    <div class="modal-btn">
      <button style="margin-right: 5px;">Xác Nhận</button>
    </div>
  </div>
</div>
<!-- NAVBAR -->
  ...
  <nav>
    ...
    <div class="profile-admin">
      ...
      <div class="profile-admin-info">
        <span>ADMIN</span>
        <span style="margin-left:10px;" id="logout-btn">LOGOUT</span>
      ...
      <div class="user__manage">
        ...
        <div class="user__manager-content">
          <div class="user__manager-content-left">
            ...
            <p>Default Address</p>
            <h4 class="user-name">Trần Đình Danh</h4>
            <h4 class="user-address">Cư xá a, Đại học Nông Lâm TPHCM</h4>
            <h4 class="user-address-detail">Thu Duc, HCM...</h4>
          </div>
          <div class="user__manager-content-right">
            <p>Default Billing Address</p>
            <h4 class="user-name">Trần Đình Danh</h4>
            <h4 class="user-address">Cư xá a</h4>
            <h4 class="user-address-detail">Thu Duc, HCM...</h4>
          </div>
        </div>
      </div>
