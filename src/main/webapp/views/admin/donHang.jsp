...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/template/admin/css/donhang.css'/>">
        ...
        <div class="list__order">
            ...
            <div class="list__order-item">
                <div class="order__item-header">
                    ...
                    <h5 > Trạng Thái Giao Dịch: <span class="sucess">Thành Công</span></h5>
                </div>
                <div class="order__item-main">
                    <img src="https://images.unsplash.com/photo-1568605114967-8130f3a36994?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8NHx8fGVufDB8fHx8&w=1000&q=80" alt="">
                    <div class="order__item-main-detail">
                        <h5 class="name-home">Nơi Thuê: <span>Lá Phong HomeStay</span></h5>
                        <h5 class="adress-home">Địa Chỉ: <span>Đà Lạt</span></h5>
                        <h5 class="day-order">Ngày Đặt: <span> 5/8/2022 - 12/8/2022</span></h5>
                        <h5 class="day-order">Giá Tiền: <span> 200$</span></h5>
                    </div>
                    <div class=""></div>
                </div>
                <div class="order__item-footer">
                    ...
                    <div class="detail">
                        <h5> <i class="fas fa-money-bill"></i> Tổng số Tiền: <span>200$</span></h5>
                        <button>Liên Hệ Với Khách Hàng</button>
                    </div>
                </div>
            </div>
            <div class="list__order-item">
                <div class="order__item-header">
                    ...
                    <h5 > Trạng Thái Giao Dịch: <span class="error">Thất Bại</span></h5>
                </div>
                <div class="order__item-main">
                    <img src="https://images.unsplash.com/photo-1568605114967-8130f3a36994?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8NHx8fGVufDB8fHx8&w=1000&q=80" alt="">
                    <div class="order__item-main-detail">
