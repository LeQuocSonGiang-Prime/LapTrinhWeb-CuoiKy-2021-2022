...
<div class="modal" id="modal">
    <div class="form-box">
        ...
        <form id="register" class="input-group" action="">
            ...
            <input type="checkbox" class="check-box" /><span
                class="checkbox-remember"
        >Tôi đồng ý với các Điều khoản & Điều kiện</span
        >
...
<div class="root">
    ...
    <div class="layout-contact">
        <div class="about-img">
            ...
            <div class="about-title-link"><a href="./index.html">Trang Chủ</a> / <span>Liên Hệ</span></div>
        </div>
        ...
        <div class="contact-content">
            <div class="contact-container">
                <div class="contact-container-info">
                    ...
                    <ul class="info">
                        <li>
                            <span><i class="ti-location-arrow"></i></span>
                            <span>Đại Học Nông Lâm TP.HCM</span>
                        </li>
                        <li>
                            <span><i class="ti-email"></i></span>
                            <span>laptrinhweb@gmai.com</span>
                        </li>
                        <li>
                            <span><i class="ti-mobile"></i></span>
                            <span>+84 28192019</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col l-3 m-6 c-6">
                    ...
                    <ul class="footer-list">
                        <p class="footer__text2">
                            Cập nhật những tin tức và sự kiện mới nhất của công ty. Nhập
                            e-mail của bạn và đăng ký nhận
                        </p>
                        <div class="footer-li">
        ...
        <div class="footer__bottom">
            <div class="grid">
                ...
                <p class="footer__text">
                    Lập Trình Web: Lê Quốc Sơn Giang - Trần Đình Danh - Phạm Công Danh
                </p>
            </div>
        </div>
    </footer>
